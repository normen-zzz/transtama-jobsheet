$(function(){
    ...
    var base_url='http://localhost/absensi/'; // Here i define the base_url
    ...
    $('#calendar').fullCalendar({
        ...
        events: base_url+'calendar2/getEvents',
        selectable: true,
        selectHelper: true,
        editable: true, // Make the event resizable true           
         ...
         eventDrop: function(event, delta, revertFunc,start,end) {  
            ...
            if(event.end){
               ...
               $.post(base_url+'calendar2/dragUpdateEvent',{                            
                id:event.id,
                start : start,
                end :end
            }, function(result){
    ...
    $('.modal').on('click', '#add-event',  function(e){
        if(validator(['title', 'description'])) {
            $.post(base_url+'calendar2/addEvent', {
                title: $('#title').val(),
    ...
    $('.modal').on('click', '#update-event',  function(e){
        if(validator(['title', 'description'])) {
            $.post(base_url+'calendar2/updateEvent', {
                id: currentEvent._id,
                title: $('#title').val(),
                description: $('#description').val(),
                color: $('#color').val()
