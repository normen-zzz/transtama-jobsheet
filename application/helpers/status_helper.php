...
function statusAp($status, $is_approve)
{
    if ($status == 0) {
        ...
        return '<span class="label label-primary label-inline font-weight-lighter" style="height:30px;background-color:#00a9bf;">Approve Manager</span>';
    } elseif ($status == 2) {
        if ($is_approve == 0) {
            return '<span class="label label-primary label-inline font-weight-lighter" style="height:30px;background-color:#00a9bf;">Approve Manager</span>';
        } else {
            return '<span class="label label-primary label-inline font-weight-lighter" style="height:30px; background-color:#ff4d00">Approve SM</span>';
        }
    } elseif ($status == 3) {
        ...
        return '<span class="label label-success label-inline font-weight-lighter" style="height:30px; background-color:#7c4dff;">Approve GM</span>';
    } elseif ($status == 7) {
