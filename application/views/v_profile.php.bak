                             ...
                             <div class="card-body">
                                 ...
                                 <div class="form-group row">
                                     ...
                                     <div class="col-lg-9 col-xl-6">
                                         ...
                                         <input class="form-control form-control-lg form-control-solid" readonly name="nama_user" type="text" value="<?= $nama_user; ?>">
                                     </div>
                                 </div>
                                 ...
                                 <div class="form-group row">
                                     ...
                                     <div class="col-lg-9 col-xl-6">
                                         <input class="form-control form-control-lg form-control-solid" readonly name="username" type="text" value="<?= $username ?>">
                                     </div>
                                 </div>
                                 <div class="form-group row">
                                     ...
                                     <div class="col-lg-9 col-xl-6">
                                         <div class="input-group input-group-lg">
                                             ...
                                             <input type="text" class="form-control form-control-lg" name="email" value="<?= $email ?>" placeholder="Email">
                                         </div>
                                     </div>
                                 </div>
                                 <div class="form-group row">
