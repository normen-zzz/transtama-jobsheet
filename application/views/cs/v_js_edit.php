                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="box">
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <form action="<?= base_url('cs/jobsheet/editMsrAction') ?>" method="POST">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control" required name="tgl_pickup" value="<?= $msr['tgl_pickup'] ?>">
                                                            <input type="text" class="form-control" hidden required name="id_msr" value="<?= $msr['id_msr'] ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1" class="font-weight-bold">STP Number (<span class="text-danger">*</span>)</label>
                                                            <input type="text" class="form-control" required name="no_stp" value="<?= $msr['no_stp'] ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1" class="font-weight-bold">Customer (<span class="text-danger">*</span>)</label>
                                                            <input type="text" class="form-control" required name="customer" value="<?= $msr['customer'] ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1" class="font-weight-bold">Address</label>
                                                            <textarea name="alamat_customer" class="form-control" rows="4"><?= $msr['alamat_customer'] ?></textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1" class="font-weight-bold">Phone Number</label>
                                                            <input type="text" class="form-control" name="no_telp" value="<?= $msr['no_telp'] ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1" class="font-weight-bold">Consignee (<span class="text-danger">*</span>)</label>
                                                            <input type="text" class="form-control" required name="consigne" value="<?= $msr['consigne'] ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1" class="font-weight-bold">Destination (<span class="text-danger">*</span>)</label>
                                                            <textarea name="destination" class="form-control" rows="4" required><?= $msr['destination'] ?></textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="exampleInputPassword1" class="font-weight-bold">Service (<span class="text-danger">*</span>)</label>
                                                            <select name="service" class="form-control" required>
                                                                <?php foreach ($service as $s) { ?>
                                                                    <option value="<?= $s['nama_service'] ?>" <?php if ($s['nama_service'] == $msr['service']) {
                                                                                                                    echo 'selected';
                                                                                                                } ?>><?= $s['nama_service'] ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1" class="font-weight-bold">Comm (<span class="text-danger">*</span>)</label>
                                                            <input type="text" class="form-control" required name="comm" value="<?= $msr['comm'] ?>">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="petugas" class="form-control" required>
                                                            <?php foreach ($driver as $s) { ?>
                                                                <option value="<?= $s['nama_user'] ?>" <?php if ($s['nama_user'] == $msr['petugas']) {
                                                                                                            echo 'selected';
                                                                                                        } ?>><?= $s['nama_user'] ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="sales" class="form-control" required>
                                                            <?php foreach ($marketing as $s) { ?>
                                                                <option value="<?= $s['nama_user'] ?>" <?php if ($s['nama_user'] == $msr['sales']) {
                                                                                                            echo 'selected';
                                                                                                        } ?>><?= $s['nama_user'] ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="keterangan" class="form-control"><?= $msr['keterangan'] ?></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1" class="font-weight-bold">Kode Mile/AWB (<span class="text-danger">*</span>)</label>
                                                        <input type="text" class="form-control" required name="kode" value="<?= $msr['kode'] ?>">
                                                    </div>
