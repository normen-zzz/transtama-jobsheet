        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <div class="card-body">
                <div class="card-toolbar">
                    <a href="<?= base_url('cs/ApExternal/detailAp/' . $this->uri->segment(5)) ?>" class="btn mr-2 text-light" style="background-color: #9c223b;">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('cs/ApExternal/addCapitalCost') ?>" method="POST">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
    ...
    <div class="modal fade" id="modal-acc-edit<?= $m['id_modal'] ?>">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('cs/ApExternal/editCapitalCostAct') ?>" method="POST">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
