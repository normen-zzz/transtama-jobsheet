...
<body style="font-family:'Open Sans',sans-serif; margin:-5px; margin-top:60px;" onload="window.print()">
                    ...
                    <tbody>
                        ...
                        foreach ($invoice as $inv) {
                            ...
                            if ($service == 'Charter Service') {
                                ...
                                $total_sales = ($inv['freight_kg'] + $packing +  $inv['special_freight'] +  $inv['surcharge'] + $insurance);
                            } else {
                                $disc = $inv['disc'];
                                // kalo gada disc
                                if ($disc == 0) {
                                ...
                                $packing = $inv['packing'];
                                $insurance = $inv['insurance'];
                                $total_sales = ($freight + $packing + $special_freight +  $inv['surcharge'] + $insurance);
                            }
                            if ($total_do == 0) {
                        ?>
                                <tr>
                                    ...
                                    <?php if ($info['print_do'] == 1) {
                                    ?>
                                        <td style="text-align: left;width:12%" rowspan="2"><?= $inv['note_cs'] ?></td>
                                    <?php } ?>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <?php if ($info['print_do'] == 1) {
                                    ?>
                                        <td style="text-align: left;width:12%"><?= $inv['note_cs'] ?></td>
                                    <?php } ?>
    ...
    <div class="content" style="border: none;margin-left: -5px; margin-right:5px;">
        ...
        <div class="title" style="text-align: center;">
            ...
            if ($info['status'] == 0) {
            ?>
                <h3>PROFORMA INVOICE REIMBURSMENT</h3>
            <?php   } else {
                echo '<h3>INVOICE REIMBURSMENT</h3>';
            }
            ?>
        </div>
        <div class="garis"></div>
        <div class="isi">
            <table style="margin-top: 50px;">
                <tr>
                    ...
                    <td>
                        <?= $reimbursment['no_invoice_reimbursment'] ?>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    ?>
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="text-align: center;width:6%"><?= $inv['koli'] ?></td>
                                <td style="text-align: center;width:8%"><?= $inv['berat_js']; ?></td>
                                <td style="text-align: center;width:15%"><?= rupiah($inv['others']); ?></td>
                        ...
                        ?>
                            ...
                            ?>
                                <tr>
                                    <?php if ($info['print_do'] == 1) {
                                    ?>
                                        <td style="text-align: center;width:8%"><?= $d['no_do'] ?></td>
                                    <?php } ?>
                                    <td style="text-align: center;width:8%"><?= tanggal_invoice($inv['tgl_pickup']) ?></td>
                                    <td style="text-align: center;width:6%"><?= $inv['tree_consignee'] ?></td>
                                    <td style="text-align: center;width:10%"><?php if ($inv['service_name'] == 'Charter Service') {
