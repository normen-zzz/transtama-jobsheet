                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="table-responsive">
                                        <form action="<?= base_url('superadmin/jobsheet/updateSalesCost') ?>" method="POST">
                                            <table class="table table-bordered" style="width:100%">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <input type="text" class="form-control" placeholder="isi no flight" name="freight_kg" value="<?= $msr['freight_kg'] ?>" style="width: 150px;"> </td>
                                                        <td> <input type="text" class="form-control" placeholder="isi no flight" name="special_freight" value="<?= $msr['special_freight'] ?>"> </td>
