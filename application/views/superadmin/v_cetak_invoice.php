...
<body style="font-family:'Open Sans',sans-serif; margin:-5px; margin-top:0px; margin-bottom: 20px;" onload="window.print()">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php } else { ?>
                                ...
                                <td style="text-align: center;"><?= $total_special_weight + $total_weight ?></td>
                            <?php } ?>
