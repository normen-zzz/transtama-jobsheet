                    ...
                    <form action="<?= base_url('finance/report/ap2') ?>" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group"> <br>
                                ...
                                <a href="<?= base_url('finance/report/exportApExcell/' . $awal . '/' . $akhir) ?>" class="btn btn-danger ml-2 mt-2">Export Excell</a>
                                <!-- <a href="<?= base_url('finance/report/exportApPdf/' . $awal . '/' . $akhir) ?>" class="btn btn-danger ml-2 mt-2">Export PDF</a> -->
