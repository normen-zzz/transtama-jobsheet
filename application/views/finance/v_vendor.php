    ...
    <div class="modal fade" id="modal-paid<?= $j['id_vendor'] ?>">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?= base_url('finance/vendor/edit') ?>" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="modal-add">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('finance/vendor/add') ?>" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
