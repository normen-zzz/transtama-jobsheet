                                                    ...
                                                    ?>
                                                        <tr>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    if ($get_revisi_so) {
                                                                        if ($get_revisi_so['status_revisi'] != 7) { ?>
                                                                            <?php if ($get_revisi_so['status_revisi'] == 4 || $get_revisi_so['status_revisi'] == 5 || $get_revisi_so['status_revisi'] == 6 || $get_revisi_so['status_revisi'] == 8) { ?>
                                                            ...
                                                            <td><?php if ($get_revisi_so) {
                                                                    echo "<span class='text-danger'>SO - $j[shipment_id]</span>";
                                                                } else {
                                                                    echo 'SO - '.$j['shipment_id'];
                                                                }  ?></td>

                                                            <!-- //No Js -->
                                                            <td><?php if ($get_revisi_so) {
                                                                    echo "<span class='text-danger'>JS - $j[shipment_id]</span>";
                                                                } else {
                                                                    echo 'JS - '. $j['shipment_id'];
                                                                }  ?></td>
                                                            <td><?= $j['shipper'] ?></td>
                                                            ...
                                                            <td><?php if ($j['status_so'] == 2) {
                                                                   ...
                                                                   if ($get_revisi_so) {
                                                                        if ($get_revisi_so['status_revisi'] != 7) {
                                                                            if ($get_revisi_so['status_revisi'] == 4 || $get_revisi_so['status_revisi'] == 5 || $get_revisi_so['status_revisi'] == 6 || $get_revisi_so['status_revisi'] == 8) {
                                                                                echo '<span class="label label-primary label-inline font-weight-lighter mt-1" style="width: 150px;">Revisi So Declined</span>';
                                                                            } else {
                                                                                echo '<span class="label label-primary label-inline font-weight-lighter mt-1" style="width: 150px;">On Progress Revisi So</span>';
                                                                            }
                                                                        } else{
                                                                            echo '<span class="label label-success label-inline font-weight-lighter mt-1" style="width: 150px;">Revisi So (DONE)</span>';
                                                                        }
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    ?>
                                                                        <a href="<?= base_url('finance/jobsheet/detailRevisi/' . $j['id']) ?>" class=" btn btn-sm text-light" style="background-color: #9c223b;">View Approved</a> <br>
                                                                        <small>Jobsheet Approve By SM</small><br>
                                                                    ...
                                                                    <?php } elseif ($get_revisi_so['status_revisi'] == 8) {
                                                                    ?>
                                                                        <a href="<?= base_url('finance/jobsheet/detailRevisi/' . $j['id']) ?>" class=" btn btn-sm text-light" style="background-color: #9c223b;">View Approved</a> <br>
                                                                        <small>Jobsheet Decline By SM</small> <br>
                                                                    <?php }
                                                                    ?>
                                                                <?php }
