                        ...
                        <div class="col-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        <a href="<?= base_url('finance/report/Exportexcel/' . $bulan . '/' . $tahun) ?>" target="blank" class="badge badge-primary ml-2">Excell</a>
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <a href="<?= base_url('finance/invoice/final') ?>" class="card card-custom bg-secondary card-stretch gutter-b">
                                                ...
                                                <div class="card-body">
                                                    <span class="svg-icon svg-icon-info svg-icon-3x ml-n1">
                                                        <i class="fa fa-dollar-sign text-secondary"></i>
                                                    </span>
                                                    <div class="text-inverse-white font-weight-bolder font-size-h5 mb-2 mt-5"><?= $invoice_created ?></div>
                                                    <div class="font-weight-bold text-inverse-white font-size-sm">Total Invoice & Proforma</div>
                                                </div>
                                                <!--end::Body-->
                                            </a>
                                            <!--end::Stats Widget 17-->
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <a href="<?= base_url('finance/invoice/final') ?>" class="card card-custom bg-secondary card-stretch gutter-b">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="text-inverse-white font-weight-bolder font-size-h5 mb-2 mt-5"><?= $invoice_proforma ?></div>
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <a href="<?= base_url('finance/invoice/final') ?>" class="card card-custom bg-secondary card-stretch gutter-b">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="font-weight-bold text-inverse-white font-size-sm">Invoice Paid</div>
                                                </div>
                                                <!--end::Body-->
                                            </a>
                                            <!--end::Stats Widget 17-->
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <a href="<?= base_url('finance/invoice/final') ?>" class="card card-custom bg-secondary card-stretch gutter-b">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="text-inverse-white font-weight-bolder font-size-h5 mb-2 mt-5"><?= $invoice_pending ?></div>
                                                    <div class="font-weight-bold text-inverse-white font-size-sm">Invoice Pending</div>
                                                </div>
                                                <!--end::Body-->
                                            </a>
                                            <!--end::Stats Widget 17-->
                                            ...
                                            <a href="<?= base_url('finance/invoice/final') ?>" class="card card-custom bg-secondary card-stretch gutter-b">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="text-inverse-white font-weight-bolder font-size-h5 mb-2 mt-5">
                                                        <?= $total_shipments - $invoice_created; ?>
                                                    </div>
                                                    <div class="font-weight-bold text-inverse-white font-size-sm">Invoice Reminder</div>
                                                </div>
                                                <!--end::Body-->
                                            </a>
                                            <!--end::Stats Widget 18-->
