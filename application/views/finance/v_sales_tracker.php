        ...
        <div class="row">
            ...
            <div class="card">
					<div class="card-header">
						<h2 class="card-title"> Sales Tracker
							<div class="row">
								<form action="<?= base_url('finance/SalesTracker/index') ?>" method="POST">
									<div class="row ml-2">
										...
										<div class="form-group"> <br>
											...
											<a href="<?= base_url('finance/SalesTracker') ?>" class="btn btn-primary mt-4 ml-1">Reset Filter</a>
										</div>
									</div>
							...
							<!-- <div class="row">
									<a target="blank" href="<?= base_url('finance/order/exportexcel/null/null/0') ?>" class="btn btn-sm btn-danger mb-3 ml-2">Export Laporan Keseluruhan</a>
								</div> -->
							<br>
