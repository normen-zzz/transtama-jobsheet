                ...
                <section class="content">
                    <form action="<?= base_url('finance/invoice/proceseditInvoiceFinal') ?>" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="exampleInputEmail1" class="font-weight-bold">Revisi</label>
                                    <div class="form-check">
                                        <input class="form-check-input" name="is_revisi" type="checkbox" value="1" <?php if ($inv['is_revisi'] == 1) {
                                                                                                                        echo 'checked';
                                                                                                                    } ?>>
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Ya
