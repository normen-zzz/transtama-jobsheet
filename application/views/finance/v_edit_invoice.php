            ...
            <div class="card-body">
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="mr-auto">
                            <center>
                                <h3 class="page-title text-center">PROFORMA INVOICE <?= $due_date['customer']
                                                                                    ?> </h3>
                            </center>
                            <div class="d-inline-block align-items-center">
                                <a href="<?= base_url('finance//invoice') ?>" class="btn text-light" style="background-color: #9c223b;">
                ...
                <section class="content">
                    <form action="<?= base_url('finance/invoice/proceseditInvoice') ?>" method="POST">
                        <div class="row">
                            <div class="col-12">
                                <div class="box">
                                    <!-- /.box-header -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" name="is_insurance" type="checkbox" value="1" <?php if ($inv['is_insurance'] == 1) {
                                                                                                                            echo 'checked';
                                                                                                                        } ?>>
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Ya
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" name="is_others" type="checkbox" value="1" <?php if ($inv['is_others'] == 1) {
                                                                                                                        echo 'checked';
                                                                                                                    } ?>>
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Ya
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" name="is_remarks" type="checkbox" value="1" <?php if ($inv['is_remarks'] == 1) {
                                                                                                                        echo 'checked';
                                                                                                                    } ?>>
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Ya
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?= base_url('finance/invoice/addShipment') ?>" method="POST">
