                                                ...
                                                <script>
                                                    ...
                                                    const data = {
                                                        ...
                                                        datasets: [{
                                                            ...
                                                            data: [<?= $totalsales ?>, <?= $apCostOfFreight + $apHandlingCharges + $apHumanResource + $apMaterial + $apOverhead + $apGeneralAmExp ?>],
                                                ...
                                                <script>
                                                    ...
                                                    const data2 = {
                                                        ...
                                                        datasets: [{
                                                            ...
                                                            data: [<?= $apCostOfFreight ?>, <?= $apHandlingCharges ?>, <?= $apHumanResource ?>, <?= $apMaterial ?>, <?= $apOverhead ?>, <?= $apGeneralAmExp ?>],
                                                            backgroundColor: [
                                                                'rgb(76, 120, 168)',
                                                                'rgb(28, 157, 189)',
                                                                'rgb(139, 50, 77)',
                                                        ...
                                                        <table id="table" class="table table-bordered" style="width:100%">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?= rupiah($apHandlingCharges) ?></td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><b><?= rupiah($apMaterial + $apHandlingCharges + $apHumanResource + $apCostOfFreight) ?></b></td>
                                                                    <td></td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="text-align: right;"><b> GROSS PROFIT</b></td>
                                                                    <?php $grossProfit = $totalsales - ($apMaterial + $apHandlingCharges + $apHumanResource + $apCostOfFreight);  ?>
