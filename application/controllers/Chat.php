...
class Chat extends CI_Controller
{
    ...
    public function GetAllOrang()
    {
        ...
        $data = $this->ChatModel->GetAllOrangKecUser($id_user);
        if (count($data) == 0) {
            $data = $this->ChatModel->GetOrangKecUser($id_user);
        }
        $belum_dibaca = $this->ChatModel->GetPesanBelumDibaca($id_user)->num_rows();
        // var_dump($data);die;
        echo json_encode(array(
            'data' => $data,
            'pesan_belum_dibaca' => $belum_dibaca
        ));
    }
    ...
    public function Baca()
    {
        ...
        $baca = $this->db->update('pesan', $data, $where);
        echo json_encode(array(
    ...
    public function CariOrang()
    {
        ...
        $data = $this->ChatModel->CariOrangKecUser($id_user, $nama_user);
